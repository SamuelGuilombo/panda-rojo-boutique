...
import { getPointsByPhone, addPointTransaction, type CustomerPointsSummary } from "@/services/pointsService"
import { Search, PlusCircle, MinusCircle, Loader2, Award, UserCheck, History, AlertCircle } from "lucide-react"
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6 text-zinc-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400">
              Administra la acumulación, redención e historial de clientes.
            </p>
          </div>
        </div>
      </div>
      ...
      {customerData && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 bg-zinc-900 border border-zinc-800 rounded-2xl p-5 shadow-xl space-y-5">
            ...
            <form onSubmit={handleTransaction} className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`py-2.5 text-xs font-semibold rounded-xl border flex items-center justify-center gap-1.5 transition-colors ${
                      actionType === "EARN"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-amber-500 hover:bg-amber-400 text-black font-bold py-3 rounded-xl text-xs flex items-center justify-center gap-2 transition-colors disabled:opacity-50 mt-2"
              >
          ...
          <div className="lg:col-span-7 bg-zinc-900 border border-zinc-800 rounded-2xl p-5 shadow-xl space-y-4">
